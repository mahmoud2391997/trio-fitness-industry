const englishContent = {
  ...
  personalTrainer:"Certified Personal Trainer",
  Trainer:"HASSAN MOHAMED",
  occupation:"Expert Body Building Coach And Nutritionist",
certified:"With Certificate Earned From",
  footer: {
