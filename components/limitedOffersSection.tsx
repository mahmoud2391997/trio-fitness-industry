...
{content.offersHeader}  
      ...
      <div className="packages w-[95%] max-w-[400px] sm:w-[70%] md:w-[90%] md:max-w-screen-md xl:w-[80%] lg:max-w-screen-xl lg:w-[80%] grid grid-cols-1 md:grid-cols-2 h-auto gap-4 m-auto">
        {offers.map((offer) => (
          <PackageComponent
            key={offer.id}
            id={offer.id}
