...
function LimitedOffersSection() {
  ...
  return (
    <div className='w-full bg-black text-white p-7'>
            <h2 className="xl:text-6xl lg:text-5xl md:text-4xl sm:text-3xl text-2xl  text-center font-bold mb-6 text-[#928c6b]">DON'T MISS OUT OUR LIMITED-TIME OFFERS!</h2>
